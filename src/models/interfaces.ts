...
// export interface IItem extends ITrainRoute {
// 	departure: IDeparture;
// 	return?: IDeparture; // это свойство может быть необязательным
// }
...
// SEGUNDA VARIANTE
// ESTA VERSION FUNCIONA, MUESTRA LOS DATOS DEL TREN DE IDA Y REGRESO, PERO LOS VAGOS SOLO DEL TREN DE IDA
...
export interface IItem extends ITrainRoute {
	departure: IDeparture;
	returnRoute?: IItem; // Cambiar a IItem
	arrival?: IDeparture; // Asegurarse de incluir esta propiedad opcional
}
...
export interface ICoach extends ITrainRoute {
	...
	linens_price: number;
	wifi_price: number;
	air_conditioning_price: number; // ESTO LO AGREGUE YO
	is_linens_included: boolean;
	train: string;
	seats: string;
}
